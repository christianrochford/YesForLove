...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    autoprefixer: {
      dist: {
        files: {
          'assets/dist/css/yesforlove.css': 'assets/dist/stylesheets/*.css'
        }
      }
    },
    ...
    concat: {
      ...
      dist: {
        ...
        dest: 'assets/dist/js/yesforlove.js'
      }
    },
    ...
    uglify: {
      ...
      dist: {
        files: {
          'assets/dist/js/yesforlove.min.js': ['assets/dist/js/yesforlove.js'],
