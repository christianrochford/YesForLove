...
return b&&b.ishwscroll?b.getScrollLeft():A.call(this)}return this.each(function(){var b=e.data(this,"__nicescroll")||!1;b&&b.ishwscroll?b.setScrollLeft(parseInt(g)):A.call(e(this),g)})};var B=function(g){var b=this;if(this.length=0,this.name="nicescrollarray",this.each=function(e){for(var g=0,a=0;g<b.length;g++)e.call(b[g],a++);return b},this.push=function(e){b[b.length]=e,b.length++},this.eq=function(e){return b[e]},g)for(var h=0;h<g.length;h++){var k=e.data(g[h],"__nicescroll")||!1;k&&(this[this.length]=k,this.length++)}return this};!function(e,b,h){for(var k=0;k<b.length;k++)h(e,b[k])}(B.prototype,"show hide toggle onResize resize remove stop doScrollPos".split(" "),function(e,b){e[b]=function(){var e=arguments;return this.each(function(){this[b].apply(this,e)})}}),e.fn.getNiceScroll=function(g){return"undefined"==typeof g?new B(this):this[g]&&e.data(this[g],"__nicescroll")||!1},e.extend(e.expr[":"],{nicescroll:function(g){return e.data(g,"__nicescroll")?!0:!1}}),e.fn.niceScroll=function(g,b){"undefined"==typeof b&&"object"==typeof g&&!("jquery"in g)&&(b=g,g=!1);var h=new B;"undefined"==typeof b&&(b={}),g&&(b.doc=e(g),b.win=e(this));var k=!("doc"in b);return!k&&!("win"in b)&&(b.win=e(this)),this.each(function(){var g=e(this).data("__nicescroll")||!1;g||(b.doc=k?e(this):b.doc,g=new N(b,e(this)),e(this).data("__nicescroll",g)),h.push(g)}),1==h.length?h[0]:h},window.NiceScroll={getjQuery:function(){return e}},e.nicescroll||(e.nicescroll=new B,e.nicescroll.options=G)});var outdatedBrowser=function(t){function o(t){s.style.opacity=t/100,s.style.filter="alpha(opacity="+t+")"}function e(t){o(t),1==t&&(s.style.display="block"),100==t&&(u=!0)}function r(){var t=document.getElementById("btnCloseUpdateBrowser"),o=document.getElementById("btnUpdateBrowser");s.style.backgroundColor=bkgColor,s.style.color=txtColor,s.children[0].style.color=txtColor,s.children[1].style.color=txtColor,o.style.color=txtColor,o.style.borderColor&&(o.style.borderColor=txtColor),t.style.color=txtColor,t.onmousedown=function(){return s.style.display="none",!1},o.onmouseover=function(){this.style.color=bkgColor,this.style.backgroundColor=txtColor},o.onmouseout=function(){this.style.color=txtColor,this.style.backgroundColor=bkgColor}}function l(){var t=!1;if(window.XMLHttpRequest)t=new XMLHttpRequest;else if(window.ActiveXObject)try{t=new ActiveXObject("Msxml2.XMLHTTP")}catch(o){try{t=new ActiveXObject("Microsoft.XMLHTTP")}catch(o){t=!1}}return t}function a(t){var o=l();return o&&(o.onreadystatechange=function(){n(o)},o.open("GET",t,!0),o.send(null)),!1}function n(t){var o=document.getElementById("outdated");return 4==t.readyState&&(o.innerHTML=200==t.status||304==t.status?t.responseText:d,r()),!1}var s=document.getElementById("outdated");this.defaultOpts={bgColor:"#f25648",color:"#ffffff",lowerThan:"transform",languagePath:"../outdatedbrowser/lang/en.html"},t?("IE8"==t.lowerThan||"borderSpacing"==t.lowerThan?t.lowerThan="borderSpacing":"IE9"==t.lowerThan||"boxShadow"==t.lowerThan?t.lowerThan="boxShadow":"IE10"==t.lowerThan||"transform"==t.lowerThan||""==t.lowerThan||"undefined"==typeof t.lowerThan?t.lowerThan="transform":("IE11"==t.lowerThan||"borderImage"==t.lowerThan)&&(t.lowerThan="borderImage"),this.defaultOpts.bgColor=t.bgColor,this.defaultOpts.color=t.color,this.defaultOpts.lowerThan=t.lowerThan,this.defaultOpts.languagePath=t.languagePath,bkgColor=this.defaultOpts.bgColor,txtColor=this.defaultOpts.color,cssProp=this.defaultOpts.lowerThan,languagePath=this.defaultOpts.languagePath):(bkgColor=this.defaultOpts.bgColor,txtColor=this.defaultOpts.color,cssProp=this.defaultOpts.lowerThan,languagePath=this.defaultOpts.languagePath);var u=!0,i=function(){var t=document.createElement("div"),o="Khtml Ms O Moz Webkit".split(" "),e=o.length;return function(r){if(r in t.style)return!0;for(r=r.replace(/^[a-z]/,function(t){return t.toUpperCase()});e--;)if(o[e]+r in t.style)return!0;return!1}}();if(!i(""+cssProp)){if(u&&"1"!==s.style.opacity){u=!1;for(var c=1;100>=c;c++)setTimeout(function(t){return function(){e(t)}}(c),8*c)}" "===languagePath||0==languagePath.length?r():a(languagePath);var d='<h6>Your browser is out-of-date!</h6><p>Update your browser to view this website correctly. <a id="btnUpdateBrowser" href="http://outdatedbrowser.com/">Update my browser now </a></p><p class="last"><a href="#" id="btnCloseUpdateBrowser" title="Close">&times;</a></p>'}};$(document).ready(function(){var winH=$(window).height();$("#love-wrapper").css({height:winH}),$("#love-menu").css({height:winH}),$(".icon-menu").click(function(e){e.preventDefault(),$(this).addClass("off"),$(".icon-close-modal").addClass("on"),$(".love-modal").removeClass("open"),$("#love-menu").addClass("on")}),$(".icon-close-modal").click(function(e){e.preventDefault(),$(this).removeClass("on"),$(".icon-menu").removeClass("off"),$("#love-menu").removeClass("on"),$(".love-modal").removeClass("open")}),$(".nav-link").click(function(e){var target=$(this).attr("href");e.preventDefault(),$(".love-modal").removeClass("open"),$("#love-menu").removeClass("on"),$("#"+target).addClass("open")}),$("#creative-lovers, #about, #contact").niceScroll({cursorcolor:"#fff",cursorborder:"none",cursorborderradius:"0"});var scrolled=0;$(".icon-arrow-down").click(function(){scrolled+=300,$("#creative-lovers").animate({scrollTop:scrolled})}),Modernizr.touch?$(".icon-share").click(function(e){e.preventDefault(),$(this).hasClass("open")?($(this).removeClass("open"),$("#love-links, #love-triangle").removeClass("on")):($(this).addClass("open"),$("#love-links, #love-triangle").addClass("on"))}):$(".icon-share").hover(function(){$(this).addClass("on"),$("#love-links, #love-triangle").addClass("on")},function(){$(this).removeClass("on"),$("#love-links, #love-triangle").removeClass("on")})}),$(window).load(function(){$("#loading").hide(),$(".flexslider, .ajax-slider").fadeIn(200),$(".flexslider").flexslider();$(window).height();$(".yes").css($(".yes").height()<$(window).height()?{paddingTop:($(window).height()-$(".yes").height())/2}:{paddingTop:($(window).height()-$(".yes").height())/2})}),$(window).resize(function(){var winH=$(window).height();$("#love-wrapper").css({height:winH}),$(".yes").css($(".yes").height()<$(window).height()?{paddingTop:($(window).height()-$(".yes").height())/2}:{paddingTop:($(window).height()-$(".yes").height())/2}),$("#love-menu").css({height:winH})});